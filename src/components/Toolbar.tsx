...
export function Toolbar() {
  ...
  return (
    <div className="toolbar-dock">
      ...
      />
        <ToolButton 
          active={mode === InteractionMode.ERASING}
          onClick={() => setTool(InteractionMode.ERASING, 'crosshair')}
          label="Eraser (E)"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 20H7L3 16C2 15 2 13 3 12L13 2L22 11L20 20Z"/><path d="M11 7L20 16"/></svg>}
        />

        <ToolButton 
          active={mode === InteractionMode.CONNECTING}
          onClick={() => setTool(InteractionMode.CONNECTING, 'alias')}
          label="Connect (C)"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>}
        />
    </div>
  );
}
